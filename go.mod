module github.com/virtual-kubelet/mac-vkubelet

go 1.19

require (
	// TODO: move back to latest version once backward incompatibility issues are resolved
	// https://github.com/kubernetes/client-go/issues/551
	// https://pkg.go.dev/k8s.io/apimachinery/pkg/util/clock
	k8s.io/api v0.19.10 // indirect
	k8s.io/apimachinery v0.25.3 // indirect
	k8s.io/client-go v0.19.10 // indirect
)

require internal/provider v1.0.0
...
require (
	...
	github.com/virtual-kubelet/node-cli v0.7.0 // indirect
